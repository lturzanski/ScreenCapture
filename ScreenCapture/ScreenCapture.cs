...
namespace ScreenCapture
{
    ...
    public static class ScreenCapturer
    {
        ...
        internal static string CaptureAndSave(string fileName, IntPtr currentHandle)
        {
            return ImageSave(fileName, null, Capture(currentHandle));
        }
        ...
        /// Image.</param>
        static string ImageSave(string filename, ImageFormat format, Image image)
        {
